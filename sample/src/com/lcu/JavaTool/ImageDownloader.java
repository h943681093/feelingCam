...
public class ImageDownloader {
	...
	private HashMap<String, MyAsyncTask> 
	map = new HashMap<String, MyAsyncTask>();
	...
	private void removeTaskFormMap(String url){
		if(url != null && map != null && map.get(url) != null){
			map.remove(url);
			System.out.println("当前map的大�?="+map.size());
		}
	}
